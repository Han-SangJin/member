...
<!-- icheck bootstrap -->
<link rel="stylesheet" href="/sources/bootstrap/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
...
<body class="hold-transition login-page">
				...
				<form action="/login/process" method="get">
					<div class="form-group has-feedback">
						<input type="text" class="form-control" name="userid" id="userid"
							placeholder="아이디를 입력하세요" value="${param.userid}">  <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
					</div>	
					<div class="form-group has-feedback">
	...
	<!-- AdminLTE App -->
	<script src="/sourcesresources/bootstrap/dist/js/adminlte.min.js"></script>
