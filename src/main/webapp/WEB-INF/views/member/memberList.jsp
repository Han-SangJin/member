...
<%
    	List<MemberVo> selectAllBoard = (List<MemberVo>) session.getAttribute("selectAllBoard");
%>    
				...
				<section class="content">
					<div class="card">
						<div class="card-header with-border">
							<a href="/memberRegist/process"><button type="button" class="btn btn-primary">회원등록</button></a>
							...
							<div class="row">
								<div class="col-sm-12">
									<table class="table table-bordered">
										...
										%>			 
											<tr data-userid="<%= selectAllBoard.get(i).getUserid() %>">
											<c:set var="userid" scope="request" value="<%= selectAllBoard.get(i).getUserid() %>"/>
												<td><%= selectAllBoard.get(i).getUserid() %></td>
												<td><%= selectAllBoard.get(i).getUsernm() %></td>
												<td><%= selectAllBoard.get(i).getAlias() %></td>
												<%-- <td><%= memberList.get(i).getReg_dt() %></td> --%>
												<td><fmt:formatDate value="<%= selectAllBoard.get(i).getReg_dt() %>" pattern="yyyy-MM-dd"/></td>
